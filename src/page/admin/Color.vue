      ...
      <div class="container row">
        ...
        <div class="col-lg-9">
          <div class="content-card">
            ...
            <button @click="show_form = !show_form" class="btn btn-outline-dark tool-bar">创建颜色</button>
            <form v-if="show_form" @submit="cou($event)">
                    ...
                    <div class="input-control">
                        <label>色号</label>
                        <input v-validator="'required'" type="text" v-model="current.hex_num">
                    </div>
